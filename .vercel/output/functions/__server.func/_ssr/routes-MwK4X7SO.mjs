...
import { i as Menu, r as Plus, t as X, u as ArrowRight } from "../_libs/lucide-react.mjs";
import { n as toast, t as Toaster } from "../_libs/sonner.mjs";
import { a as HERO, c as PLANS, d as STUDIO_PLANS, f as STUDIO_QUESTIONS, i as CONTACT, l as PROJECT_CTA, m as WHAT_WE_DO, o as HERO_VIDEO, s as PARTNERS, u as STUDIO_INDUSTRIES } from "./router-BjdLsA6f.mjs";
import { t as Footer } from "./footer-DyMbnIPH.mjs";
import { t as BrandImage } from "./brand-image-B23lfHks.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-MwK4X7SO.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function Header({ scrolled, open, onToggle, onJump }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
		className: cn("fixed top-0 right-0 left-0 z-40 transition-[background-color] duration-300", scrolled || open ? "bg-ink/95" : "bg-transparent"),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							className: "ml-3 inline-flex min-h-11 items-center bg-vellum px-4 font-sans text-[13px] font-medium text-ink transition-[opacity] duration-150 hover:opacity-90",
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								type: "button",
								onClick: () => onJump("conversation"),
								className: "rise rise-4 inline-flex min-h-12 w-fit items-center bg-vellum px-6 font-sans text-[13px] font-medium text-ink transition-[opacity] duration-150 hover:opacity-90",
								children: HERO.cta
							})]
						})
					]
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				...
				className: "body-copy-compact mt-3 max-w-md text-limestone",
				children: "The hotels, fleets, and developments we work alongside. Their marks are on the way."
			})]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("figure", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
					...
					className: "mt-10 inline-flex min-h-11 items-center gap-2 bg-ink px-5 font-sans text-[13px] font-medium text-vellum transition-[opacity] duration-150 hover:opacity-90",
					children: [
						"Explore ",
						industry.name,
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					className: cn("font-sans text-xs tabular-nums", quiet),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: cn("body-copy-compact mt-10", quiet),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					type: "button",
					onClick: () => onJump("conversation"),
					className: cn("inline-flex min-h-11 items-center justify-center px-5 font-sans text-[13px] font-medium transition-[opacity,background-color,border-color] duration-150", plan.featured ? "bg-ink text-vellum hover:opacity-90" : "border border-vellum/20 text-vellum hover:border-vellum/40 hover:bg-vellum/5"),
					children: ["Talk about ", plan.name]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
					to: "/plans/$planId",
					params: { planId: plan.id },
					className: cn("inline-flex underline underline-offset-4 min-h-11 items-center justify-center px-5 font-sans text-[13px] transition-[opacity] duration-150 hover:opacity-70", quiet),
					children: [
						"See what ",
						plan.name,
						" holds"
...
function ProjectCta({ onJump }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		"aria-labelledby": "project-title",
		className: "bg-vellum px-6 pt-28 pb-20 text-ink md:px-12 md:pt-40 md:pb-28 lg:px-16",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "mx-auto max-w-7xl",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "grid overflow-hidden rounded-lg bg-night text-vellum lg:grid-cols-2",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(BrandImage, {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
							id: "project-title",
							className: "font-display text-3xl font-light md:text-4xl",
							children: PROJECT_CTA.title
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "body-copy mt-8 max-w-md text-limestone",
							children: PROJECT_CTA.body
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "mt-10",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								children: [PROJECT_CTA.cta, /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, {
									className: "size-4",
									"aria-hidden": "true"
								})]
							})
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						...
						children: "The things people usually ask before the first conversation. Anything else, bring it to the call."
					})]
				})
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									...
									className: cn("flex size-9 shrink-0 items-center justify-center rounded-full bg-ink text-vellum motion-safe:transition-transform motion-safe:duration-300", expanded ? "rotate-45" : void 0),
									"aria-hidden": "true",
...
function Studio() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Plans, { onJump: jump }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ProjectCta, { onJump: jump }),
