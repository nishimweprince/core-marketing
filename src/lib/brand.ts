...
export const SECTIONS = [
  ...
  { id: "house", num: "01", label: "The House" },
  { id: "position", num: "02", label: "Position" },
  { id: "mark", num: "03", label: "The Mark" },
  { id: "colour", num: "04", label: "Colour" },
  { id: "type", num: "05", label: "Type" },
  { id: "voice", num: "06", label: "Voice" },
  { id: "image", num: "07", label: "Image" },
  { id: "applications", num: "08", label: "Applications" },
  { id: "system", num: "09", label: "System" },
] as const;
...
export const PRACTICES = [
  {
    ...
    holds: ["The position", "The narrative", "The brief"],
  },
  {
    roman: "II",
    name: "Presence",
